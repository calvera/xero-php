...
class Allocations extends Object
{
    ...
    {
        return [
            'Allocations' => [false, self::PROPERTY_TYPE_OBJECT, 'Accounting\\Overpayment\\Allocation', true, false]
        ];
    }
    ...
    {
        return 'Overpayments/%s/Allocations';
    }
    ...
    public function save()
    {
        ...
        if ($this->isDirty()) {
            ...
            $uri = sprintf(self::getResourceURI(), $this->getOverpaymentID());
